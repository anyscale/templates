"""
Step 2: Run the screening pipeline on Ray Data.
...
def main():
    parser = argparse.ArgumentParser(description="Protein Screening Pipeline")
    ...
    parser.add_argument("--num-gpus", type=int, default=4,
                        help="Number of GPU workers for the scoring stage")
