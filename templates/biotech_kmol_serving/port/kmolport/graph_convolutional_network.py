"""GraphConvolutionalNetwork — verbatim from kMoL, only import paths rewritten
to the vendored minimal package. Attribute names (convolutions / read_out /
molecular_head / mlp) are unchanged so checkpoint keys match exactly.
"""
