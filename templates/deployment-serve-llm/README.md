...
**[Deploy a small-sized LLM](./small-size-llm/README.md)**  
Deploy small-sized models on a single GPU, such as Llama 3 8&nbsp;B, Mistral 7&nbsp;B, or Phi-2.  

---

**[Deploy a medium-sized LLM](./medium-size-llm/README.md)**  
