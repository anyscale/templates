...
def embed_ray_docs():
    ...
    all_docs_gen = Path("/mnt/user_storage/docs.ray.io/").rglob("*")
    ...
    ray_docs_index.storage_context.persist(persist_dir=RAY_DOCS_INDEX)
...
def embed_ray_blogs():
    ...
    ray_blogs_index.storage_context.persist(persist_dir=RAY_BLOGS_INDEX)
