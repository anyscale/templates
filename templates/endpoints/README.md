...
** Note that AWS offers A10G GPUs while GCP offers L4. Please switch to the correct config file for the GPU type. All config files follow the naming convention `{model name}_{accelerator_type}_{tensor_parallelism}`. The supported accelerator types are: T4, L4, A10G, A100-40G and A100-80G. 
