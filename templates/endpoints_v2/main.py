...
from utils import (LLAMA_MODELS, MODEL_ID_TO_BASE_CONFIGS, get_cloud_provider,
                   get_gpu_type, get_hf_token, get_tensor_parallelism, populate_configs, _read_yaml_file, get_model)
...
def main():
    ...
    base_config = _read_yaml_file(config_file_path)
    ...
    serve_config = _read_yaml_file(_BASE_SERVE_CONFIG_PATH)
