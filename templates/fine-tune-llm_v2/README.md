...
$ WANDB_API_KEY={YOUR_WANDB_API_KEY} python main.py training_configs/full_param/llama-2-7b-512-16xa10.yaml
...
You can specify this URI as the `dynamic_lora_loading_path` in the serving workspace template, and then query the endpoint.
...
You can follow the `Learn how to bring your own models` section under the endpoints template to serve this finetuned model with the specified storage uri.
