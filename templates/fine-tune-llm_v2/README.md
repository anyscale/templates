...
* [Bring your own weights](cookbooks/bring_your_own_weights/README.md): Bring weights of a model with a similar architecture to the Llama or Mistral family of open-source models for fine-tuning.
