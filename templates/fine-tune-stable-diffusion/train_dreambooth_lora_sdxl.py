# This script is taken from this diffusers example with very minor modifications:
# https://github.com/huggingface/diffusers/blob/d7634cca87641897baf90f5a006f2d6d16eac6ec/examples/dreambooth/train_dreambooth_lora_sdxl.py
# See comments starting with `MODIFICATION:` for the places where changes were made.
...
class DreamBoothDataset(Dataset):
    ...
    def __init__(
        self,
        # MODIFICATION: This argument was added because `args` is not a
        # globally accessible variable when we launch this with Ray Train.
        args,
        instance_data_root,
        instance_prompt,
        class_prompt,
...
def main(args):
    ...
    if accelerator.is_main_process:
        ...
        # MODIFICATION: Don't do a final round of inference at the end of training.
