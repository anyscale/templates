...
- [fintech-tfm-fidelity-principle](fintech-tfm-fidelity-principle.md) — faithfully reimplement NVIDIA; Ray is the ONLY difference; result gaps = divergences to eliminate, not modeling to explore
