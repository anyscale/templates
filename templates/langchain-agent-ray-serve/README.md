...
**Docker Image:** For optimal compatibility and performance, use the Docker image `anyscale/ray-llm:2.58.0-py312-cu130`. This image includes Ray 2.58.0, Python 3.12, and CUDA 13.0 support, providing all necessary dependencies for LLM serving with GPU acceleration.
