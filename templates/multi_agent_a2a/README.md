...
<div align="left">
  ...
  <a href="https://github.com/anyscale/templates/tree/main/templates/multi_agent_a2a" role="button"><img src="https://img.shields.io/static/v1?label=&message=View%20On%20GitHub&color=586069&logo=github&labelColor=2f363d"></a>&nbsp;
</div>
...
- **Ray repository**: [`langchain_agent_ray_serve`](https://github.com/anyscale/templates/tree/main/templates/langchain-agent-ray-serve)
...
**Docker image:**
- Use `anyscale/ray-llm:2.56.0-py312-cu130` for optimal compatibility.
...
See the code in [`llm/llm_deploy_qwen.py`](https://github.com/anyscale/templates/blob/main/templates/multi_agent_a2a/llm/llm_deploy_qwen.py). This file deploys Qwen as an OpenAI-compatible API with tool calling support.
...
See [mcps/weather_mcp_server.py](https://github.com/anyscale/templates/blob/main/templates/multi_agent_a2a/mcps/weather_mcp_server.py):
...
See [mcps/web_search_mcp_server.py](https://github.com/anyscale/templates/blob/main/templates/multi_agent_a2a/mcps/web_search_mcp_server.py):
...
The configuration module [`agent_runtime/config.py`](https://github.com/anyscale/templates/blob/main/templates/multi_agent_a2a/agent_runtime/config.py) centralizes configuration loading for LLM and MCP settings from environment variables.
...
The agent builder module [`agent_runtime/agent_builder.py`](https://github.com/anyscale/templates/blob/main/templates/multi_agent_a2a/agent_runtime/agent_builder.py) provides factory functions for building LangChain agents, centralizing LLM setup, MCP tool discovery, and agent creation to eliminate boilerplate.
...
The SSE deployment module [`agent_runtime/serve_deployment.py`](https://github.com/anyscale/templates/blob/main/templates/multi_agent_a2a/agent_runtime/serve_deployment.py) builds the FastAPI application and Ray Serve deployment for the human-to-agent chat interface.
...
**File:** [`agents/weather_agent_with_mcp.py`](https://github.com/anyscale/templates/blob/main/templates/multi_agent_a2a/agents/weather_agent_with_mcp.py)
...
**File:** [`agents/research_agent_with_web_search_mcp.py`](https://github.com/anyscale/templates/blob/main/templates/multi_agent_a2a/agents/research_agent_with_web_search_mcp.py)
...
**File:** [`agents/travel_agent_with_a2a.py`](https://github.com/anyscale/templates/blob/main/templates/multi_agent_a2a/agents/travel_agent_with_a2a.py)
...
**A2A components:**
- Server endpoints: [`agent_runtime/a2a_deployment.py`](https://github.com/anyscale/templates/blob/main/templates/multi_agent_a2a/agent_runtime/a2a_deployment.py) (deployment factory).
- AgentCard helper: [`protocols/a2a_card.py`](https://github.com/anyscale/templates/blob/main/templates/multi_agent_a2a/protocols/a2a_card.py) (discovery).
- Client helper: [`protocols/a2a_client.py`](https://github.com/anyscale/templates/blob/main/templates/multi_agent_a2a/protocols/a2a_client.py) (execution).

#### AgentCard helper

**File:** [`protocols/a2a_card.py`](https://github.com/anyscale/templates/blob/main/templates/multi_agent_a2a/protocols/a2a_card.py)
...
**File:** [`protocols/a2a_client.py`](https://github.com/anyscale/templates/blob/main/templates/multi_agent_a2a/protocols/a2a_client.py)
...
See [`serve_multi_config.yaml`](https://github.com/anyscale/templates/blob/main/templates/multi_agent_a2a/serve_multi_config.yaml) for the complete deployment configuration.
