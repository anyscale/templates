...
- **Online model serving**: Deploy the model as a scalable online service using [Ray Serve](https://docs.ray.io/en/latest/serve/index.html). See [Scalable online XGBoost inference with Ray Serve](https://github.com/anyscale/templates/blob/main/templates/xgboost-training-and-serving/notebooks/03-Serving.ipynb).
